    ...
    <div className="flex flex-col h-full px-2">
        ...
        {navItems.map(({ href, label, icon: Icon }) => {
          ...
          return (
            ...
            >
              ...
              {label === "Notifikasi" && (
                <span className="ml-auto w-2 h-2 bg-brand rounded-full" />
              )}
            </Link>
          );
        })}
      ...
      <div className="mt-auto pt-4 border-t border-dark-300">
        <Link
          ...
          className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-dark-200 transition-colors"
        >
        ...
        <button
          ...
          className="sidebar-link w-full text-red-400 hover:text-red-300 hover:bg-red-950/30 mt-1"
        >
